export default function About() {
  return (
    <div className="about">
      ...
      <img src={"/images/avocados.jpg"} width="690px" alt="avocados"/>
      <article>
        <span>1</span><strong>Most avocados come from Mexico</strong>
      ...
      <article>
        <span>2</span><strong>The conquistadors were huge fans.</strong>
      ...
      <article>
        <span>3</span><strong>"Avocado" wasn't its original name.</strong>
      ...
      <article>
        <span>4</span> <strong>It's actually a fruit.</strong>
      ...
      <article>
        <span>5</span><strong>There's a secret trick to ripening them up quick</strong>
